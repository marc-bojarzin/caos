#ifndef CAOS_WEAK_INTRUSIVE_POINTER_HPP
#define CAOS_WEAK_INTRUSIVE_POINTER_HPP
...
public:
    ...
    static constexpr bool has_weak_ptr_semantics = true;  // semantics trait
...
#endif // CAOS_WEAK_INTRUSIVE_POINTER_HPP
